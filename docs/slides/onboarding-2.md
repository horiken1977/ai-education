...
<!-- _class: lead -->
# オンボーディング（第2回）
## 定義：AIに“仕事の素材”を渡す型＋研修の地図

**このセッションが終わったら…**
会議をTeams録画→Copilotで**議事録・報告・次アクションを自力で作れる**

<small>営業フロー上の担当：②記録する（全員必須）／前回のおさらいを図解で速く</small>
...
| 時間 | 内容 |
|---|---|
| 0:00–0:13 | 全体像＝3ヶ月の地図（営業が変わる／進め方／レベルと卒業条件） |
| 0:13–0:18 | はじめのお約束＋「とにかくやってみよう」 |
| 0:18–0:35 | 会議録画→要約→**8項目プロンプトで議事録に整形** |
| 0:35–0:48 | ブレイクアウト（数人で議論・共有） |
| 0:48–1:00 | まとめ・QAタイム・アンケート |
...
**② セッションは「きっかけ」。身につくのは場の外**

<div class="flow">
  <span class="node">セッション<br><small>入力＋体験</small></span>
  <span class="node accent">自習</span>
  <span class="node goal">日々の業務で活用</span>
</div>

> セッション以外の時間を最大限に。ここは出発点です。
...
| LV1 | チャットAIでPPT | ディスカッション・ペーパーを調べる→構成→スライド化で1本作れる |
