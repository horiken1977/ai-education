...
言い回しは自由に変えてOK。ただし次の“語そのもの”をスライドから消すとCIが赤になります：
  一気通貫 / RFP / 手を動か / 成果物 / 卒業条件 / LV3 / ①調べる / 渡し方 / 混在型 / 7割
...
⑤ チャットボットに会議の要約を指示する（指示文は自分デカが得てみてください）
```

> どんな要約が出てきたかを以下のBoxNoteに共有してください
