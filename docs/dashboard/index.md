...
### テンプレート集
- [テンプレート集](../toolkit/index.md) … 各回の配布テンプレ（Genspark伏字プロンプトテンプレ等）。
...
混在型・週1回60分・3ヶ月。下表は **[カリキュラム設計書](../design/curriculum.md) §4 が正本**で、ここは自動取り込み（編集は設計書側で）。

--8<-- "design/curriculum.md:schedule"
